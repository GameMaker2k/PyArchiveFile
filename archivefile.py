...
'''
    ...
    $FileInfo: archivefile_py3.py - Last Update: 2/8/2026 Ver. 0.28.8 RC 1 - Author: cooldude2k $
'''
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    if active_action == "create":
        if getargs.convert:
            checkcompressfile = pyarchivefile.CheckCompressionSubType(input_file, fnamedict, getargs.filestart, True)
            if (
